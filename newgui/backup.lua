...
do -- checks
    ...
    --
    do -- initialize menu
        menu = loadstring(game:HttpGetAsync("https://pastebin.com/raw/FwYCKBzj"))();
...
local tabs = {
    ["combat"] = window:tabs({name = "assist", icon = "http://www.roblox.com/asset/?id=101187718648966", size = udim2_new(0, 25, 0, 28)}),
    ["visuals"] = window:tabs({name = "visuals", icon = "http://www.roblox.com/asset/?id=13571270194", size = udim2_new(0, 35, 0, 38)}),
    ["misc"] = window:tabs({name = "misc", icon = "http://www.roblox.com/asset/?id=8998290803", size = udim2_new(0, 28, 0, 28)}),
    ["colors"] = window:tabs({name = "colors", icon = "http://www.roblox.com/asset/?id=78489916461314", size = udim2_new(0, 35, 0, 35)}),
    ["settings"] = window:tabs({name = "settings", icon = "http://www.roblox.com/asset/?id=11663743444", size = udim2_new(0, 34, 0, 34)}) -- http://www.roblox.com/asset/?id=11348555035
};
--
do -- main
    ...
    do -- initialize main
        ...
        do -- functions
            function visualenhancements:esp_tab()
                do -- esp
                    local esp = tabs["visuals"]:section({name = "esp", risky = false, side = "left"});
                    --
                    esp:toggle({name = "Name", description = "Draw entity name", default = false, flag = "Enable Names"});
                    esp:toggle({name = "Bounding Box", description = "Draw entity box", default = false, flag = "Enable Boxes"});
                    esp:toggle({name = "Filled Box", description = "Draw entity filled box", default = false, flag = "Boxes Filled"});
                    esp:slider({name = "Filled Opacity", min = 0, max = 100, default = 80, decimals = 1, suffix = "%", flag = "Boxes Filled Opacity"});
                    esp:toggle({name = "Healthbar", description = "Draw entity healthbar", default = false, flag = "Enable Healthbar"});
                    esp:slider({name = "Healthbar Width", min = 1, max = 4, default = 2, decimals = 1, suffix = "", flag = "Healthbar Width"});
                    esp:dropdown({name = "Side", description = "Healthbar side", options = {"Left", "Bottom"}, default = "Left", flag = "Healthbar Side"});
                    esp:toggle({name = "Distance", description = "Draw entity distance", default = false, flag = "Enable Distances"});
                    esp:toggle({name = "Weapon", description = "Draw entity weapon", default = false, flag = "Enable Weapons"});
                    esp:toggle({name = "Flags", description = "Draw entity flags", default = false, flag = "Enable Flags"});
                    esp:dropdown({name = "Flags mode", description = "Select flags", options = {"Visible", "SpeedHack", "AFK"}, default = { "Visible" }, Max = 3, Flag = "Flags Type"})
                    esp:toggle({name = "OOF Arrows", description = "Draw entity arrow", default = false, flag = "Enable Arrows"});
                    esp:dropdown({name = "Arrows From", description = "Arrow position", options = { "Screen", "Mouse" }, default = "Screen", flag = "Arrows From"});
                    esp:toggle({name = "Skeletons", description = "Draw entity skeletons", default = false, flag = "Enable Skeletons"});
                    esp:slider({name = "Skeleton Thickness", min = 1, max = 2, default = 1, decimals = 1, suffix = "", flag = "Skeleton Thickness"});
                    esp:toggle({name = "View Angle", description = "Draw entity viewangles", default = false, flag = "Enable ViewAngle"});
                    esp:slider({name = "View Angle Length", min = 1, max = 15, default = 5, decimals = 10, suffix = "", flag = "ViewAngle Length"});
                    esp:toggle({name = "Visible Icon", description = "Draw entity vis-icons", default = false, flag = "Enable Visible Icons"});
                    esp:toggle({name = "Highlight Chams", description = "Draw entity chams", default = false, flag = "Enable Chams"});
                    esp:slider({name = "Chams Opacity", min = 0, max = 100, default = 50, decimals = 1, suffix = "", flag = "Chams Opacity"});
                    esp:dropdown({name = "Chams Type", description = "Chams vis-check", options = { "Visible Only", "Always Visible" }, default = "Always Visible", flag = "Chams Visible Check"});
                end;
                --
                do -- misc
                    local esp_misc = tabs["visuals"]:section({name = "misc", risky = false, side = "center"});
                    --
                    esp_misc:toggle({name = "Info Viewer", description = "Draw info viewer", default = false, flag = "Info Viewer"});
                    esp_misc:slider({name = "X-Position", min = 0, max = 100, default = 50, decimals = 1, suffix = "", flag = "Info X-Pos"});
                    esp_misc:slider({name = "Y-Position", min = 0, max = 100, default = 15, decimals = 1, suffix = "", flag = "Info Y-Pos"});
                end;
                --
                do -- other
                    local esp_other = tabs["visuals"]:section({name = "settings", risky = false, side = "right"});
                    --
                    esp_other:slider({name = "Max Distance", min = 100, max = 1000, default = 250, decimals = 0.1, suffix = "", flag = "Max ESP Distance"});
                    esp_other:toggle({name = "Team Check", description = "Ignores Friendlies", default = false, flag = "ESP Teamcheck"});
                    esp_other:toggle({name = "Lerp Health", description = "Lerps health", default = false, flag = "Lerp Health"});
                    esp_other:toggle({name = "Animate Chams", description = "Animates highlight chams", default = false, flag = "Chams Thermal"});
                    esp_other:toggle({name = "Outline", description = "Outline skeleton/viewangle", default = false, flag = "Outline Skeletons/ViewAngle"});
                    esp_other:toggle({name = "Rainbow", description = "Rainbow skeleton/viewangle", default = false, flag = "Rainbow Skeletons/ViewAngle"});
                    esp_other:slider({Name = "Arrow Radius", min = 100, max = 750, default = 250, decimals = 1, suffix = "°", flag = "OOF Radius" });
                    esp_other:slider({name = "Arrow Size", min = 16, max = 32, default = 22, decimals = 1, suffix = "", flag = "Arrow Size"});
                    esp_other:dropdown({name = "Arrow Points", description = "Arrow Type", options = { "Three", "Four" }, default = "Four", flag = "Arrow Points"});
                    esp_other:dropdown({name = "ESP Font", description = "Custom ESP Fonts", options = {"Proggy", "Medodica", "Templeos", "Pixel"}, default = "Proggy", flag = "ESP Fonts"})
                end;
            end;
            --
            ...
            -- 
            function visualenhancements:combat_tab()
                do -- assist
                    do -- general
                        local general = tabs["combat"]:section({name = "general", risky = false, side = "left"});
                        --
                        general:toggle({name = "Enabled", description = "Toggle aim-assist", default = false, flag = "Enable Aim-Assist"});
                        general:keybind({name = "Aim-Assist", description = "Aim-assist key", default = Enum.UserInputType.MouseButton2, usekey = true, ignore = true, flag = "Aim-Assist Keybind"});
                        general:toggle({name = "Visible check", description = "Target visible only", default = false, flag = "Visible Check"});
                        general:toggle({name = "Team Check", description = "Ignores Friendlies", default = false, flag = "Friendly Check"});
                        general:dropdown({name = "Aimbot mode", description = "Select aimbot mode", options = {"Aimbot", "pSilent"}, default = { "Aimbot" }, Max = 2, Flag = "Aimbot Mode"})
                        general:dropdown({name = "pSilent mode", description = "Select pSilent mode", options = {"Raycast", "Search"}, default = "Raycast", flag = "pSilent Mode"});
                        general:dropdown({name = "Target Bone", description = "Aim-Assist Parts", options = {"Head", "UpperTorso", "LowerTorso", "LeftUpperArm", "RightUpperArm", "LeftLowerArm", "RightLowerArm", "LeftLeg", "RightLeg", "LeftFoot", "RightFoot", "Random"}, default = "Head", flag = "Aimbot Bone"});
                        general:slider({name = "Aimbot Speed", min = 0.1, max = 1, default = 0.5, decimals = 10, suffix = "", flag = "Aimbot Speed"});
                        general:slider({name = "Hitchance", min = 25, max = 100, default = 100, decimals = 1, suffix = "", flag = "Silent Aim Hitchance"});
                        general:slider({name = "FOV", min = 30, max = 750, default = 150, decimals = 1, suffix = "px", flag = "FOV Radius"});
                    end;
                    --
                    do -- options
                        local options = tabs["combat"]:section({name = "select", risky = false, side = "center"});
                        --
                        options:slider({name = "Max Distance", min = 30, max = 1000, default = 250, decimals = 0.1, suffix = "", flag = "Aimbot Max Distance"});
                        options:toggle({name = "Highlight Target", description = "Aimbot Highlight", default = false, flag = "Highlight ESP"});
                        options:toggle({name = "Snaplines", description = "Draw Snaplines", default = false, flag = "Enable Snaplines"});
                        options:toggle({name = "FOV Circle", description = "Draw FOV", default = false, flag = "Enable FOV"});
                        options:toggle({name = "FOV Outlined", description = "Draw Outlined FOV", default = false, flag = "Enable Outlined FOV"});
                        options:toggle({name = "FOV Filled", description = "Draw Filled FOV", default = false, flag = "Enable Filled FOV"});
                        options:toggle({name = "Highlight FOV", description = "FOV Highlight on Target", default = false, flag = "Highlight FOV"});
                        options:slider({name = "Filled Opacity", min = 0, max = 100, default = 95, decimals = 1, suffix = "%", flag = "FOV Filled Opacity"});
                        options:slider({name = "Animation Speed", min = 100, max = 1000, default = 250, decimals = 0.1, suffix = "s", flag = "FOV Animation Speed"});
                    end;
                    --
                    do -- misc
                        local misc = tabs["combat"]:section({name = "misc", risky = true, side = "right"});
                        --
                        misc:toggle({name = "Manipulation", description = "Shoot around walls", default = false, flag = "Enable Manipulation"});
                        misc:slider({name = "Manipulation Ammount", min = 1, max = 10, default = 5, decimals = 10, suffix = "", flag = "Manipulation Ammount"});
                    end;
                    --
                end;
            end;
            ...
            player_esp.update_player_ESP = function(player)
                ...
                do -- update esp
                    ...
                    player_esp.update_esp = LPH_NO_VIRTUALIZE(function()
                        ...
                        if (max_distance > flags["Max ESP Distance"]) then
                            for _, v in ipairs({"name", "flag1", "icon_top", "box", "box2", "distance", "weapon", "BehindHealthbar", "Healthbar", "Arrow"}) do
                                drawings[v].Visible = false;
                            end;
                            chams.Enabled = false;
        ...
        do -- UI
            do -- combat
                visualenhancements:combat_tab();
            end;
            --
            do -- visuals
                visualenhancements:esp_tab();
            end;
            --
            do -- misc
                do -- character
                    local character = tabs["misc"]:section({name = "character", risky = true, side = "left"});
                    --
                    character:toggle({name = "Speedhack", description = "Speedhack Toggle", default = false, flag = "Speedhack" });
                    character:slider({name = "Speedhack Speed", min = 10, max = 200, default = 50, decimals = 1, suffix = "", flag = "Speedhack Speed" });
                    character:toggle({name = "Spiderman", description = "Climb up walls", default = false, flag = "Spiderclimb" });
                    --[[
    ...
    do -- initialize main
        ...
        do -- looping
            ...
            do --
                    ...
                    character:slider({name = "Spiderman Speed", min = 0.5, max = 1.5, default = 0.75, decimals = 100, suffix = "", flag = "Spiderclimb Speed" });
                    character:toggle({name = "Noclip", description = "Phase through walls", default = false, flag = "noclip" });
                    character:keybind({name = "Noclip", description = "Noclip Keybind", flag = "noclip_key", mode = "Toggle", usekey = false });
                    character:toggle({name = "Local Chams", description = "Customie character", default = false, flag = "Local Chams"});
                    character:colorpicker({ name = "Local Chams accent", description = "Local Chams color", default = Color3.fromRGB(131,135,250), flag = "Local Chams accent"});
                    character:slider({name = "Local Chams Opacity", min = 0, max = 100, default = 50, decimals = 1, suffix = "%", flag = "Local Chams Opacity" });
                end;
                -- 
                do -- camera
                    local camera = tabs["misc"]:section({name = "camera", risky = false, side = "center"});
                    --
                    camera:toggle({name = "Viewmodel", description = "Changes viewmodel", default = false, flag = "Viewmodel Enabled" });
                    camera:slider({name = "X Position", min = -5, max = 5, default = 0, decimals = 5, suffix = "", flag = "Xpos" });
                    camera:slider({name = "Y Position", min = -5, max = 5, default = 0, decimals = 5, suffix = "", flag = "Ypos" });
                    camera:slider({name = "Z Position", min = -5, max = 5, default = 0, decimals = 5, suffix = "", flag = "Zpos" });
                    --
                    camera:toggle({name = "Screen Resolution", description = "Edit screen-res", default = false, flag = "screen_res" });
                    camera:slider({name = "Width", min = 100, max = viewport_size.X, default = viewport_size.X, decimals = 1, suffix = "", flag = "screen_width" });
                    camera:slider({name = "Height", min = 100, max = viewport_size.Y, default = viewport_size.Y, decimals = 1, suffix = "", flag = "screen_height" });
                end;
                --
                do -- lighting
                    local lighting_tab = tabs["misc"]:section({name = "lighting", risky = false, side = "right"});
                    --
                    lighting_tab:toggle({name = "Ambience", description = "Enable ambience", default = false, flag = "ambience" });
                    lighting_tab:toggle({name = "Force Time", description = "Changes game time", default = false, flag = "force_time" });
                    lighting_tab:slider({name = "Clock", min = 1, max = 24, default = lighting.ClockTime, decimals = 1, suffix = "h", flag = "clock_time" });
                    lighting_tab:toggle({name = "Luminance", description = "Enable brightness", default = false, flag = "luminance" });
                    lighting_tab:slider({name = "Luminance Ammount", min = 1, max = 5, default = lighting.Brightness, decimals = 1, suffix = "", flag = "luminance_amm" });
                    lighting_tab:toggle({name = "Remove Fog", description = "Removes fog", default = false, flag = "remove_fog" });
                    lighting_tab:dropdown({name = "Skyboxes", description = "Custom sky", options = skys, flag = "skybox", callback = function(state)
                    ...
                    --
                    local old_technology = tostring(lighting.Technology["Name"]);
                    lighting_tab:dropdown({name = "Technology", description = "Change Technology", options = { "Future", "Compatibility", "Legacy", "ShadowMap", "Voxel", "Unified" }, default = old_technology, flag = "Technology", callback = function(state) lighting.Technology = Enum.Technology[state]; end});
                    -- 
                    local colorcorrection_tab = tabs["misc"]:section({name = "color correction", risky = false, side = "right"});
                    -- 
                    colorcorrection_tab:toggle({name = "Enabled", description = "Enable color correction", default = false, flag = "Enable Color Correction", callback = function(state) color_correct.Enabled = state; end});
                    colorcorrection_tab:slider({name = "Saturation Ammount", min = 0, max = 10, default = color_correct.Saturation or 0, decimals = 10, suffix = "", flag = "Saturation Ammount", callback = function(state) color_correct.Saturation = state; end});
                    colorcorrection_tab:slider({name = "Contrast Ammount", min = 0, max = 10, default = color_correct.Contrast or 0, decimals = 10, suffix = "", flag = "Contrast Ammount", callback = function(state) color_correct.Contrast = state; end});
                end;
                --
            end;
            --
            do -- colors
                visualenhancements:color_tab();
            end;
            --
            do -- settings
                do -- menu
            ...
            do -- hooking
                --[[LPH_NO_VIRTUALIZE(function() 
                    local old_namecall; old_namecall = hookmetamethod(game, "__namecall", newcclosure(function(...)
                        local method, args, self = getnamecallmethod():lower(), {...}, ...;

                        if (flags["Enable Aim-Assist"] and table.find(flags["Aimbot Mode"], "pSilent") and self == workspace and not checkcaller()) and aiming then 
                            local hit_part, ray = target_enhancements.target.part, args[2];

                            if (hit_part and math.random(1, 100) <= flags["Silent Aim Hitchance"]) then
                                if (flags["pSilent Mode"] == "Raycast" and method == "raycast") then
                                    args[3] = (hit_part.Position - ray).Unit * flags["Aimbot Max Distance"];
                                elseif (flags["pSilent Mode"] == "Search" and method:match("findpartonray")) then
                                    args[2] = Ray.new(ray.Origin, (hit_part.Position - ray.Origin).Unit * flags["Aimbot Max Distance"]);
                                end
                                return old_namecall(table.unpack(args));
                            end
                        end
                        return old_namecall(...);
                    end), true);   
